...
If you prefer combined examples, start with the `case/` mainline:

1. [Case Entry](case/README.en.md)
2. [Configuration System with `xvalue + json`](case/json-config-system.en.md)
3. [Rendering HTML with Template](case/template-render-html.en.md)
...
9. [Minimal HTTP Service with XRT](case/minimal-http-service.en.md)
10. [Streaming LLM API with XRT](case/streaming-llm-api.en.md)
11. [Full HTTP + JSON + Template Service Chain](case/http-json-template-chain.en.md)
12. [Signed Rule Bundle Import with Charset, Regex, and Crypto](case/signed-rule-bundle.en.md)
13. [Session Registry with `mempool + avltree + list`](case/session-registry-pool-index.en.md)
14. [A Local Console Service that Combines Config, Logging, Tasks, Networking, and Templates](case/local-console-service.en.md)

Heavier pages about cache/archive/recovery/consensus/snapshots/leases/journals are no longer presented as one endlessly growing default route.

Use [Case Entry](case/README.en.md) to choose between the 3 reading layers:
