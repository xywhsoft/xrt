...
| P1 | 卷一：ch01/02 重写、memory 拆 2 章、temp、新增 core 章（版本/ABI/模块查询/单头原理）、卷导言 | 8 | ⬜ |
...
1. 读 `BOOK_SPEC.md`、本文件对应阶段行、金标准章（03/52）、`PROGRESS.md`。
...
3. 读金标准章 docs/book/03-error.md 与 docs/book/52-net-tcp.md，以其深度、结构、语气为基准
