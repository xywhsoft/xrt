...
| P25 | 卷十三·项目上：CLI 工具/配置服务/聊天服务（设计+实现） | 5 | ✅ 完成（137/138 本阶段 + 139-141 由 P27 补齐，5/5） |
| P26 | 卷十三·项目下：下载器/WebSocket 服务 + 全书收官 | 5 | ✅ 完成（实际 3 章：设计章已并入各实现章；原遗留的 P25 ch139-141 已由 P27 补齐） |
| P27 | 收尾：index.html 目录全量重建、卷导言核对、全站链接校验、漂移总报告、CI 接线 | — | ✅ 完成（另补齐 P25 遗留 139-141，全书 144 章成型；遗留 ch09 无 md 源） |
| P27 | 教学缺口补充：ch09 补写 + pattern/html/future_bridge/task_net/http1_net/http1_tls 并节（三语言，含 i18n 同步 I29） | 1+6 并节 | ✅ 完成 |
