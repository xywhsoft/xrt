...
- **Domain boundary**: this chapter's `&` domain; Chapter 91's `;` domain — iterators same-shaped, different grammar.
...
| Boundary with Chapter 91 | this chapter's & domain (URI/forms); Chapter 91's ; domain (header field values) |
