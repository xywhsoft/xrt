...
- **Light callbacks**: callbacks only set flags/enqueue; heavy work is the main loop's (Chapter 47's discipline, signal edition).
- **Send/receive division**: this chapter receives; sending signals to children is Chapter 52's process module.
...
/* drain bounded by time (Chapter 41 deadline); timeout or second signal -> exit immediately */
...
| Mask management | ignore/restore/batch unregister - temporarily mute a signal then restore; send/receive division: sending is Chapter 52 |
