...
| 体系 | API 起点 | 典型示例 |
| --- | --- | --- |
| 基础与文本 | [String](../api/string.md)、[Pattern](../api/pattern.md)、[Regex](../api/regex.md)、[Charset](../api/charset.md)、[Number](../api/number.md)、[Time](../api/time.md) | `examples/string`、`examples/text/pattern`、`examples/text/regex`、`examples/number`、`examples/time` |
