...
25. [把本地控制台服务升级成一个多层存储面板](case/multi-tier-storage-dashboard.md)
26. [把本地控制台服务升级成一个冷热多级老化面板](case/hot-cold-multi-level-aging-dashboard.md)
27. [把本地控制台服务升级成一个恢复优先级面板](case/recovery-priority-dashboard.md)
28. [把本地控制台服务升级成一个跨介质编排面板](case/cross-media-orchestration-dashboard.md)
29. [把本地控制台服务升级成一个重链路恢复面板](case/heavy-recovery-chain-dashboard.md)
30. [把本地控制台服务升级成一个恢复配额面板](case/recovery-quota-dashboard.md)
31. [把本地控制台服务升级成一个跨机器恢复面板](case/cross-machine-recovery-dashboard.md)
32. [把本地控制台服务升级成一个分布式编排面板](case/distributed-orchestration-dashboard.md)
33. [把本地控制台服务升级成一个持久化协调面板](case/persistent-coordination-dashboard.md)
34. [把本地控制台服务升级成一个一致性仲裁面板](case/consensus-arbitration-dashboard.md)
35. [把本地控制台服务升级成一个共识日志复制面板](case/consensus-log-replication-dashboard.md)
36. [把本地控制台服务升级成一个状态机提交面板](case/state-machine-commit-dashboard.md)
37. [把本地控制台服务升级成一个日志回放面板](case/log-replay-dashboard.md)
38. [把本地控制台服务升级成一个快照压缩面板](case/snapshot-compaction-dashboard.md)
39. [把本地控制台服务升级成一个租约故障切换面板](case/lease-failover-dashboard.md)
40. [把本地控制台服务升级成一个领导切换恢复面板](case/leader-handoff-recovery-dashboard.md)
41. [把本地控制台服务升级成一个 compaction 接管面板](case/compaction-takeover-dashboard.md)
42. [把本地控制台服务升级成一个 ownership 仲裁面板](case/ownership-arbitration-dashboard.md)
43. [把本地控制台服务升级成一个分布式接管编排面板](case/distributed-takeover-orchestration-dashboard.md)
44. [把本地控制台服务升级成一个共识式 ownership 面板](case/consensus-style-ownership-dashboard.md)
