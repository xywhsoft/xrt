...
- [Benchmark Methodology](/D:/git/xrt/dev/bench/XRT_FOUNDATION_BENCHMARK_METHOD.md)
- [XNet Comparison Baseline](/D:/git/xrt/dev/bench/XNET_COMPARE_20260314.md)
- [TLS Baseline](/D:/git/xrt/dev/bench/TLS_BENCH_20260315.md)
