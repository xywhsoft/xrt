...
- Failure returns the empty-string sentinel
...
- The runtime may cache this result for features such as XID machine identification
...
int main() {
	...
	// XID uses the runtime-cached local IP as machine identifier
...
- [Base Module](api-base.en.md) - runtime init, error handling, and global configuration
