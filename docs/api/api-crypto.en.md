...
> Cryptographic primitive module used by the current TLS and network mainline

[English](api-crypto.en.md) | [中文](api-crypto.md) | [Back to Index](README.en.md)
...
**Crypto** is the cryptographic primitive layer used by the current XRT TLS and network mainline. It combines multiple independently sourced algorithm implementations and internal integration work into one unified module, with the following features:
...
This module is not documented as a single third-party code drop. Different algorithms come from different source lineages, and XRT integrates them into one internal crypto layer.
