...
__asm__(
	...
	"str x0, [sp, #224]\n"
	"str w1, [sp, #232]\n"
	"adr x9, .LtestCoroAbiArm64Host\n"
	"cbnz w1, .LtestCoroAbiArm64Load\n"
	"adr x9, .LtestCoroAbiArm64Fiber\n"
	".LtestCoroAbiArm64Load:\n"
	"ldp x19, x20, [x9, #0]\n"
	"ldp x21, x22, [x9, #16]\n"
	"ldp x23, x24, [x9, #32]\n"
	"ldp x25, x26, [x9, #48]\n"
	...
	"mov x10, sp\n"
	"and x10, x10, #15\n"
	"cbnz x10, .LtestCoroAbiArm64Fail\n"
	"ldr w10, [sp, #232]\n"
	"cbz w10, .LtestCoroAbiArm64Yield\n"
	"ldr x0, [sp, #224]\n"
	"bl " TEST_CORO_ASM_SYMBOL(xrtCoResume) "\n"
	"and w0, w0, #255\n"
	"b .LtestCoroAbiArm64Called\n"
	".LtestCoroAbiArm64Yield:\n"
	"bl " TEST_CORO_ASM_SYMBOL(xrtCoYield) "\n"
	"cmp w0, #0\n"
	"cset w0, eq\n"
	".LtestCoroAbiArm64Called:\n"
	"str w0, [sp, #236]\n"
	"adr x9, .LtestCoroAbiArm64Host\n"
	"ldr w10, [sp, #232]\n"
	"cbnz w10, .LtestCoroAbiArm64Check\n"
	"adr x9, .LtestCoroAbiArm64Fiber\n"
	".LtestCoroAbiArm64Check:\n"
	"ldr x10, [x9, #0]\n"
	"cmp x19, x10\n"
	"b.ne .LtestCoroAbiArm64Fail\n"
	"ldr x10, [x9, #8]\n"
	"cmp x20, x10\n"
	"b.ne .LtestCoroAbiArm64Fail\n"
	"ldr x10, [x9, #16]\n"
	...
	"b.ne .LtestCoroAbiArm64Fail\n"
	"ldr w0, [sp, #236]\n"
	"b .LtestCoroAbiArm64Restore\n"
	".LtestCoroAbiArm64Fail:\n"
	"mov w0, #0\n"
	".LtestCoroAbiArm64Restore:\n"
	"ldp q14, q15, [sp, #192]\n"
	"ldp q12, q13, [sp, #160]\n"
	"ldp q10, q11, [sp, #128]\n"
	"ldp q8,  q9,  [sp, #96]\n"
