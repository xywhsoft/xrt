...
TARGETS = {
	...
	"acme-dns": {
		"module": "acme_dns_response_fuzz_tests",
		"manifest": "extlibs/xacme/config/modules.json",
		"label": "xacme DNS TXT response",
		"output": "acme_dns_response_fuzz",
		"adapter": "XACME_DNS_FUZZ_LIBFUZZER",
		"corpus": "acme_dns_response",
		"seeds": {
			"empty": b"",
			"valid": bytes([
			...
			"nxdomain": bytes([
				0x12,0x34,0x81,0x83,0x00,0x00,0x00,0x00,
				0x00,0x00,0x00,0x00,
			]),
			"split": bytes([
				0x12,0x34,0x81,0x80,0x00,0x00,0x00,0x01,
