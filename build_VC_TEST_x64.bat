...
cl /nologo /TC /utf-8 /std:c11 /W3 /Fe:release\x64\test.exe /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_WARNINGS /D_WINSOCK_DEPRECATED_NO_WARNINGS test.c /link Ws2_32.lib IPHLPAPI.lib Shell32.lib || exit /b 1
...
echo.
echo build_VC_TEST_x64.bat: PASS
exit /b 0
