...
gcc -std=c11 -Wall -Wextra -I. -Ilib ^
    ...
    examples\smoke_real_provider_probe_azure_openai_file_url.c ^
    -o build\smoke_real_provider_probe_azure_openai_file_url.exe ^
    -lws2_32 -liphlpapi -lshell32 -lcrypt32

if not "%errorlevel%"=="0" exit /b %errorlevel%

build\smoke_real_provider_probe_azure_openai_file_url.exe
exit /b %errorlevel%
