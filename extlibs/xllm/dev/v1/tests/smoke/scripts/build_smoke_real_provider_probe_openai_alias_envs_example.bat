...
gcc -std=c11 -Wall -Wextra -I. -Ilib ^
    ...
    examples\smoke_real_provider_probe_openai_alias_envs.c ^
    -o build\smoke_real_provider_probe_openai_alias_envs.exe ^
    -lws2_32 -liphlpapi -lshell32 -lcrypt32

if not "%errorlevel%"=="0" exit /b %errorlevel%

build\smoke_real_provider_probe_openai_alias_envs.exe
exit /b %errorlevel%
