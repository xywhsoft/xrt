...
static uint32 smoke_server_thread(ptr pParam)
{
    ...
    char aBuffer[8192];
    const char *sBody =
        "{\"id\":\"chatcmpl-openai-output-artifacts\","
        "\"object\":\"chat.completion\","
        "\"model\":\"gpt-output-artifacts\","
        "\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":["
        "{\"type\":\"output_text\",\"text\":\"probe openai output artifacts ok\"},"
        "{\"type\":\"image_url\",\"image_url\":{\"url\":\"https://example.invalid/probe.png\",\"mime_type\":\"image/png\",\"name\":\"probe.png\"}},"
        "{\"type\":\"file\",\"file\":{\"file_data\":\"cHJvYmUtcmVwb3J0LWJ5dGVz\",\"mime_type\":\"application/pdf\",\"filename\":\"probe.pdf\"}}"
        "]},\"finish_reason\":\"stop\"}],"
...
int main(void)
{
    ...
    char sBaseUrl[256];
    const char *sSummaryPath = "build\\probe_openai_output_artifacts.summary.json";
    ...
    if ( smoke_setenv_cstr("XLLM_REAL_ADAPTER", "openai_compat") != 0 ||
         ...
         smoke_setenv_cstr("XLLM_REAL_MODEL", "gpt-output-artifacts") != 0 ||
         ...
         smoke_setenv_cstr("XLLM_REAL_EXPECT_TEXT_CONTAINS", "probe openai output artifacts ok") != 0 ||
    ...
    printf("smoke_real_provider_probe_openai_output_artifacts ok\n");
