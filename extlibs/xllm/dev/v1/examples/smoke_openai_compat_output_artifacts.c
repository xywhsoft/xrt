...
static uint32 demo_server_thread(ptr pParam)
{
    ...
    char aBuffer[4096];
    const char *sBody =
        "{\"id\":\"chatcmpl-output-artifacts\","
        "\"object\":\"chat.completion\","
        "\"model\":\"gpt-output-mock\","
        "\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":["
        "{\"type\":\"output_text\",\"text\":\"Here is the generated output.\"},"
        "{\"type\":\"image_url\",\"image_url\":{\"url\":\"https://example.invalid/generated.png\",\"mime_type\":\"image/png\",\"name\":\"generated.png\"}},"
        "{\"type\":\"file\",\"file\":{\"file_data\":\"cmVwb3J0LWJ5dGVz\",\"mime_type\":\"application/pdf\",\"filename\":\"report.pdf\"}}"
        "]},\"finish_reason\":\"stop\"}],"
...
int main(void)
{
    ...
    tProfile.sId = "openai-output-artifacts";
    ...
    tProfile.tModels.tText.sModelId = "gpt-output-mock";
    if ( xllm_register_profile(pRuntime, &tProfile) != XRT_NET_OK ) {
        fprintf(stderr, "register profile failed\n");
        return 9;
    }

    tCreate.sInitialProfileId = "openai-output-artifacts";
    ...
    printf("smoke_openai_compat_output_artifacts ok\n");
