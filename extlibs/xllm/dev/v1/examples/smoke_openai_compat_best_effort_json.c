...
int main(void)
{
    ...
    tProfile.sId = "openai-local-json";
    ...
    tCreate.sInitialProfileId = "openai-local-json";
    ...
    if ( tServer.iRequestCount != 1 || tServer.iUnexpectedResponseFormatCount != 0 ) {
        fprintf(
            stderr,
            "unexpected request counters: request=%d response_format=%d\n",
