...
static uint32 demo_server_thread(ptr pParam)
{
    ...
    char aBuffer[4096];
    const char *sBody =
        "{\"model\":\"llama-mock\",\"message\":{\"role\":\"assistant\",\"content\":\"partial \"},\"done\":false}\n"
        "{\"model\":\"llama-mock\",\"message\":{\"role\":\"assistant\",\"content\":\"answer\"},\"done\":false}\n"
        "{\"model\":\"llama-mock\",\"message\":{\"role\":\"assistant\",\"content\":\"\"},\"done\":true,\"done_reason\":\"length\",\"prompt_eval_count\":10,\"eval_count\":5}\n";
...
int main(void)
{
    ...
    tProfile.sId = "ollama-stream-length";
    ...
    tCreate.sInitialProfileId = "ollama-stream-length";
    tCreate.sSystemPrompt = "You are ollama stream length test";
