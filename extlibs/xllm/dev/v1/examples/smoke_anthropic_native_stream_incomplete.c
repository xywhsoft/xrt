...
static uint32 demo_stream_server_thread(ptr pParam)
{
    ...
    const char *sHeader =
        ...
        "request-id: req_anthropic_stream_incomplete_1\r\n"
        "Cache-Control: no-cache\r\n"
        "Connection: close\r\n"
        "Transfer-Encoding: chunked\r\n"
        "\r\n";
    const char *sEvent1 =
        "data: {\"type\":\"message_start\",\"message\":{\"id\":\"msg_stream_incomplete\",\"type\":\"message\",\"role\":\"assistant\",\"model\":\"claude-incomplete-mock\",\"usage\":{\"input_tokens\":11,\"output_tokens\":0}}}\n\n";
    const char *sEvent2 =
...
int main(void)
{
    ...
    tProfile.sId = "anthropic-stream-incomplete";
    ...
    tCreate.sInitialProfileId = "anthropic-stream-incomplete";
    ...
    if ( tEvents.iTextDeltaCount != 2 || tEvents.iEndCount != 1 ) {
        fprintf(stderr, "unexpected event counters: delta=%d end=%d\n", tEvents.iTextDeltaCount, tEvents.iEndCount);
        return 17;
    }
    ...
    if ( tTrace.iRequestTraceCount != 1 || tTrace.iIncompleteTraceCount != 1 || tTrace.iStreamFinalizeTraceCount < 1 ) {
        fprintf(stderr, "unexpected trace counters\n");
        return 19;
    }
