...
static uint32 demo_server_thread(ptr pParam)
{
    ...
    while ( iHandled < 2 ) {
        ...
        if ( iHandled == 0 ) {
            const char *sBody =
                "{\"id\":\"chatcmpl-session-artifacts-1\","
                "\"object\":\"chat.completion\","
                "\"model\":\"gpt-session-mm\","
                "\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":["
                "{\"type\":\"output_text\",\"text\":\"first artifact reply\"},"
                "{\"type\":\"image_url\",\"image_url\":{\"url\":\"https://example.invalid/session.png\",\"mime_type\":\"image/png\",\"name\":\"session.png\"}},"
                "{\"type\":\"file\",\"file\":{\"file_id\":\"file-session-1\",\"mime_type\":\"application/pdf\",\"filename\":\"session.pdf\"}}"
                "]},\"finish_reason\":\"stop\"}],"
            ...
            const char *sBody =
                "{\"id\":\"chatcmpl-session-artifacts-2\","
                "\"object\":\"chat.completion\","
                "\"model\":\"gpt-session-mm\","
                "\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":\"follow-up ok\"},\"finish_reason\":\"stop\"}],"
                "\"usage\":{\"prompt_tokens\":5,\"completion_tokens\":2,\"total_tokens\":7}}";

            if ( strstr(aBuffer, "\"role\":\"assistant\",\"content\":[") != NULL &&
                 strstr(aBuffer, "\"type\":\"text\",\"text\":\"first artifact reply\"") != NULL &&
                 strstr(aBuffer, "\"type\":\"image_url\",\"image_url\":{\"url\":\"https://example.invalid/session.png\"}}") != NULL &&
                 strstr(aBuffer, "\"type\":\"file\",\"file\":{\"file_id\":\"file-session-1\"}}") != NULL &&
...
int main(void)
{
    ...
    tProfile.sId = "openai-session-mm";
    ...
    tSessionOptions.sProfileId = "openai-session-mm";
    ...
    if ( !xllm_response_get_text(pResponse) || strcmp(xllm_response_get_text(pResponse), "first artifact reply") != 0 ) {
    ...
    if ( !xllm_response_get_text(pResponse) || strcmp(xllm_response_get_text(pResponse), "follow-up ok") != 0 ) {
    ...
    printf("smoke_openai_compat_session_output_artifacts ok\n");
