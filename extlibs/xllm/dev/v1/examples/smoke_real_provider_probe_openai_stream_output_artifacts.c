...
static uint32 smoke_server_thread(ptr pParam)
{
    ...
    const char *sHeader =
        ...
        "\r\n";
    const char *sEvent1 =
        "data: {\"id\":\"chatcmpl-probe-stream-artifacts\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-probe-stream-artifacts\","
        "\"choices\":[{\"index\":0,\"delta\":{\"role\":\"assistant\",\"content\":[{\"type\":\"output_text\",\"text\":\"probe openai stream output artifacts ok\"}]},\"finish_reason\":null}]}\n\n";
    const char *sEvent2 =
        "data: {\"id\":\"chatcmpl-probe-stream-artifacts\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-probe-stream-artifacts\","
        "\"choices\":[{\"index\":0,\"delta\":{\"content\":[{\"type\":\"image_url\",\"image_url\":{\"url\":\"https://example.invalid/probe-stream.png\",\"mime_type\":\"image/png\",\"name\":\"probe-stream.png\"}}]},\"finish_reason\":null}]}\n\n";
    const char *sEvent3 =
        "data: {\"id\":\"chatcmpl-probe-stream-artifacts\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-probe-stream-artifacts\","
        "\"choices\":[{\"index\":0,\"delta\":{\"content\":[{\"type\":\"file\",\"file\":{\"file_data\":\"c3RyZWFtLXByb2JlLWZpbGU=\",\"mime_type\":\"application/pdf\",\"filename\":\"probe-stream.pdf\"}}]},\"finish_reason\":null}]}\n\n";
    const char *sEvent4 =
        "data: {\"id\":\"chatcmpl-probe-stream-artifacts\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-probe-stream-artifacts\","
    ...
    xrtSleep(10);
    if ( !smoke_send_chunk(hClient, sDone) ) return 9u;
...
int main(void)
{
    ...
    char sBaseUrl[256];
    const char *sSummaryPath = "build\\probe_openai_stream_output_artifacts.summary.json";
    ...
    if ( smoke_setenv_cstr("XLLM_REAL_ADAPTER", "openai_compat") != 0 ||
         ...
         smoke_setenv_cstr("XLLM_REAL_MODEL", "gpt-probe-stream-artifacts") != 0 ||
         ...
         smoke_setenv_cstr("XLLM_REAL_EXPECT_TEXT_CONTAINS", "probe openai stream output artifacts ok") != 0 ||
    ...
    if ( !smoke_file_contains(sSummaryPath, "\"stream_mode\":3") ||
        ...
        fprintf(stderr, "summary file missing stream artifact counters\n");
        iExitCode = 10;
        goto cleanup;
    }

    printf("smoke_real_provider_probe_openai_stream_output_artifacts ok\n");
