/*
 * GLM 无状态对话范例（Anthropic 兼容）
 *
 * 演示使用底层无状态 API（xllm_chat_ex）通过 Anthropic 原生协议连接智谱 AI GLM 平台。
 * 单轮对话，无会话上下文。
 *
 * 编译:
 ...
 *       -o build\glm_stateless.exe -lws2_32 -liphlpapi -lshell32 -lcrypt32
 */
