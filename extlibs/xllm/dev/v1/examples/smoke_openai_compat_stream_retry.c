    ...
    for ( iAttempt = 0; iAttempt < 2; ++iAttempt ) {
        ...
        if ( iAttempt == 0 ) {
            ...
            int iRespLen = snprintf(
                ...
                "x-request-id: req-stream-retry-1\r\n"
                "Connection: close\r\n"
                "Content-Length: %u\r\n"
                "\r\n"
                "%s",
            ...
            const char *sHeader =
                ...
                "Connection: close\r\n"
                "x-request-id: req-stream-retry-2\r\n"
                "Transfer-Encoding: chunked\r\n"
                "\r\n";
            const char *sEvent1 =
                "data: {\"id\":\"chatcmpl-stream-retry\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-mock\","
                "\"choices\":[{\"index\":0,\"delta\":{\"role\":\"assistant\",\"content\":\"echo: \"},\"finish_reason\":null}]}\n\n";
            const char *sEvent2 =
                "data: {\"id\":\"chatcmpl-stream-retry\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-mock\","
                "\"choices\":[{\"index\":0,\"delta\":{\"content\":\"hello \"},\"finish_reason\":null}]}\n\n";
            const char *sEvent3 =
                "data: {\"id\":\"chatcmpl-stream-retry\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-mock\","
                "\"choices\":[{\"index\":0,\"delta\":{\"content\":\"retry \"},\"finish_reason\":null}]}\n\n";
            const char *sEvent4 =
                "data: {\"id\":\"chatcmpl-stream-retry\",\"object\":\"chat.completion.chunk\",\"model\":\"gpt-mock\","
            ...
            xrtSleep(20u);
            if ( !demo_stream_retry_send_chunk(hClient, sDone) ) return 17u;
...
int main(void)
{
    ...
    tProfile.sId = "openai-stream-retry-local";
    ...
    tCreate.sInitialProfileId = "openai-stream-retry-local";
    ...
    if ( xllm_turn_add_user_text(&tTurn, "hello retry stream") != XRT_NET_OK ) {
    ...
    if ( !sText || strcmp(sText, "echo: hello retry stream") != 0 ) {
    ...
    if ( tServer.iAuthedRequestCount != 2 || tServer.iStreamRequestCount != 2 || tServer.iAttemptCount != 2 ) {
        fprintf(
            stderr,
            "unexpected request counters: auth=%d stream=%d attempts=%d\n",
