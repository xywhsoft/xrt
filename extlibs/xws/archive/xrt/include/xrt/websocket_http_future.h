...
#include <xrt/websocket_http.h>
...
#if defined(XRT_FEATURE_WEBSOCKET_CLIENT_FUTURE) && \
	(!defined(XRT_FEATURE_WEBSOCKET_HTTP_FUTURE) || \
	 !defined(XRT_FEATURE_WEBSOCKET_CLIENT) || \
	 !defined(XRT_FEATURE_FUTURE))
	#error "XRT WebSocket client Future requires client, result and Future support"
#endif
	...
	(!defined(XRT_FEATURE_WEBSOCKET_HTTP_FUTURE) || \
	 ...
	 !defined(XRT_FEATURE_FUTURE))
	#error "XRT WebSocket server Future requires server, result and Future support"
#endif
