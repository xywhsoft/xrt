...
#if defined(XHTTP_FEATURE_HTTP_ETAG) && !defined(XRT_FEATURE_HTTP)
	#error "XRT HTTP entity-tag support requires XRT_FEATURE_HTTP"
#endif

#if defined(XHTTP_FEATURE_HTTP_PRECONDITION) && \
	(!defined(XHTTP_FEATURE_HTTP_ETAG) || !defined(XRT_FEATURE_TIME_TEXT))
	#error "XRT HTTP precondition support requires entity-tag and time text support"
#endif

#if defined(XHTTP_FEATURE_HTTP_RANGE) && !defined(XRT_FEATURE_HTTP)
...
#if defined(XHTTP_FEATURE_HTTP_ETAG)
