/* 验证 Worker 内 Future 通知退出后才允许连续 AGAIN 重用 waiter。 */
...
#define TEST_HTTP_CLIENT_STREAM_BODY_SPURIOUS 1
#define TEST_HTTP_CLIENT_STREAM_SCENARIO "reentrant body readiness"
