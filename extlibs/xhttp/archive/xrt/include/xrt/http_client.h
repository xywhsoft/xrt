...
#include <xrt/url.h>
...
#if defined(XRT_FEATURE_HTTP_CLIENT_PREPARE)
	#include <xrt/http1.h>
#endif
	...
	defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH_BASIC) || \
	defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH_BEARER) || \
	defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH_DIGEST) || \
	defined(XRT_FEATURE_HTTP_CLIENT_PREPARE_AUTH_DIGEST_SESSION) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_BASIC) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_BEARER) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST_CHOOSE) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST_INFO) || \
	defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST_SESSION)
	#include <xrt/http_auth.h>
#endif

#if defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_QUERY) || \
	defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_FORM)
	#include <xrt/query_params.h>
#endif

#if defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_FORM_DATA) || \
	defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_FORM_DATA_RANDOM)
	...
	!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST)
	...
	(!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH) || \
...
#if defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH_BEARER) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH) || \
...
#if defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH_DIGEST) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_AUTH) || \
...
#if defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_FORM) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST) || \
	 !defined(XRT_FEATURE_QUERY_PARAMS))
...
#if defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_FORM_DATA) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST) || \
	 !defined(XRT_FEATURE_FORM_DATA_MULTIPART))
	...
	(!defined(XRT_FEATURE_HTTP_CLIENT_REQUEST_FORM_DATA) || \
	 !defined(XRT_FEATURE_FORM_DATA_RANDOM))
...
#if defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE) && \
	!defined(XRT_FEATURE_HTTP_HEADERS)
...
#if defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST_INFO) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH) || \
...
#if defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST_SESSION) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT_RESPONSE_AUTH_DIGEST_INFO) || \
	 !defined(XRT_FEATURE_HTTP_AUTH_DIGEST_SESSION))
