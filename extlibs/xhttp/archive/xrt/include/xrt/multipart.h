...
#include <xrt/http_content_disposition.h>
...
#if defined(XRT_FEATURE_MULTIPART_RANDOM)
	...
	(!defined(XRT_FEATURE_MIME) || \
	 !defined(XRT_FEATURE_HTTP_CONTENT_DISPOSITION))
	#error "XRT Multipart support requires MIME and Content-Disposition support"
#endif

#if defined(XRT_FEATURE_MULTIPART_WRITE) && \
	!defined(XRT_FEATURE_MULTIPART)
	#error "XRT Multipart writer requires XRT_FEATURE_MULTIPART"
#endif

#if defined(XRT_FEATURE_MULTIPART_STREAM) && \
	!defined(XRT_FEATURE_MULTIPART)
	#error "XRT Multipart stream reader requires XRT_FEATURE_MULTIPART"
#endif
