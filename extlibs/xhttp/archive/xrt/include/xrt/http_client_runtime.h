...
#include <xrt/http_client_stream.h>
	...
	(!defined(XRT_FEATURE_HTTP_CLIENT_STREAM) || \
	 !defined(XRT_FEATURE_NET_TCP_DIAL) || \
	 !defined(XRT_FEATURE_CANCEL))
	#error "XRT HTTP client support requires HTTP stream, TCP Dial and cancellation"
#endif

#if defined(XRT_FEATURE_HTTP_CLIENT_CACHE) && \
	(!defined(XRT_FEATURE_HTTP_CACHE_STORE) || \
	 !defined(XRT_FEATURE_HTTP_CACHE_RANGE) || \
	 !defined(XRT_FEATURE_HTTP_RANGE_MULTIPART) || \
	 !defined(XRT_FEATURE_MULTIPART) || \
	...
	(!defined(XRT_FEATURE_HTTP_CLIENT) || \
	 !defined(XRT_FEATURE_HTTP_CLIENT_TLS) || \
...
#if defined(XRT_FEATURE_HTTP_CLIENT_RETRY) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT) || \
	 !defined(XRT_FEATURE_HTTP_RETRY) || \
...
#if defined(XRT_FEATURE_HTTP_CLIENT_COOKIES) && \
	(!defined(XRT_FEATURE_HTTP_CLIENT) || \
	 !defined(XRT_FEATURE_COOKIE_JAR_HEADERS))
