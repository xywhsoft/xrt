...
#if defined(XRT_FEATURE_FORM_DATA_MULTIPART) && \
	(!defined(XRT_FEATURE_FORM_DATA) || \
	 !defined(XRT_FEATURE_MULTIPART_WRITE) || \
	 !defined(XRT_FEATURE_HTTP_BODY_COMPOSE))
...
#if defined(XRT_FEATURE_FORM_DATA_RANDOM) && \
	(!defined(XRT_FEATURE_FORM_DATA_MULTIPART) || \
	 !defined(XRT_FEATURE_MULTIPART_RANDOM))
