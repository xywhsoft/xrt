...
#include <xrt/mime.h>
	...
	(!defined(XRT_FEATURE_HTTP_SERVER_REPLY) || \
	 ...
	 !defined(XRT_FEATURE_HTTP_VARY) || \
	 !defined(XRT_FEATURE_HTTP_BODY_DEFLATE) || \
	 !defined(XRT_FEATURE_HTTP_CACHE) || \
	 !defined(XRT_FEATURE_MIME) || \
	 !defined(XRT_FEATURE_HTTP_ETAG))
	#error "XRT HTTP Reply compression requires Reply, encoding, Vary, cache, body Deflate, MIME and ETag support"
#endif

#if defined(XRT_FEATURE_HTTP_SERVER_COMPRESS) && \
	(!defined(XRT_FEATURE_HTTP_REPLY_COMPRESS) || \
