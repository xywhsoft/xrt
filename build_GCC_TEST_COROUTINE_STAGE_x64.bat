...
gcc -m64 dev/test_xnet2_sync_core.c -I . -lWs2_32 -lIPHLPAPI -DDEBUG_TRACE -O2 -s -ffunction-sections -fdata-sections -Wl,--gc-sections -o release/x64/test_xnet2_sync_core.exe || goto :eof
gcc -m64 dev/test_xnet2_listener_accept_core.c -I . -lWs2_32 -lIPHLPAPI -DDEBUG_TRACE -O2 -s -ffunction-sections -fdata-sections -Wl,--gc-sections -o release/x64/test_listener_accept_core.exe || goto :eof
