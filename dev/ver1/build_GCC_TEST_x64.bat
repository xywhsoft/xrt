...
gcc -m64 test\test_value_weak.c xrt.c -I . -lWs2_32 -lIPHLPAPI -O2 -s -ffunction-sections -fdata-sections -Wl,--gc-sections %GCC_WARN% -o release/x64/test_value_weak.exe || exit /b 1
release\x64\test_value_weak.exe || exit /b 1
...
gcc -m64 test\test_json_set.c xrt.c -I . -lWs2_32 -lIPHLPAPI -O2 -s -ffunction-sections -fdata-sections -Wl,--gc-sections %GCC_WARN% -o release/x64/test_json_set.exe || exit /b 1
release\x64\test_json_set.exe || exit /b 1
